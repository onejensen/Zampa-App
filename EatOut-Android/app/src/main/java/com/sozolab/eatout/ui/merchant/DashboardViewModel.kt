...
import com.sozolab.eatout.data.model.DietaryInfo
...
class DashboardViewModel @Inject constructor(
    ...
    fun createMenu(title: String, description: String, price: Double, photoData: ByteArray, tags: List<String>, dietaryInfo: DietaryInfo = DietaryInfo(), offerType: String? = null, includesDrink: Boolean = false, includesDessert: Boolean = false, includesCoffee: Boolean = false) {
        viewModelScope.launch {
            _isLoading.value = true
            try {
                firebaseService.createMenu(title, description, price, "EUR", photoData, tags, _isPremium.value, dietaryInfo, offerType, includesDrink, includesDessert, includesCoffee)
